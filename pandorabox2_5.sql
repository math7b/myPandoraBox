...
(49, 'anime', NULL, 'Ookami to Koushinryou', 'Spice and Wolf', 'spice_and_wolf.jpg', 2008, 13, 1, 'Adventure, Fantasy, Historical, Romance', '(+ou-) 24 minutos', NULL, 'Holo é uma poderosa divindade lupina que é celebrada e reverenciada na pequena cidade de Pasloe para abençoar a colheita anual. No entanto, à medida que os anos passam e os aldeões se tornam mais auto-suficientes, Holo, que se estiliza como o \'lobo sábio de Yoitsu\', foi reduzido a um mero conto popular. Quando um mercador viajante chamado Kraft Lawrence para em Pasloe, Holo se oferece para se tornar seu parceiro de negócios se ele eventualmente a levar para sua casa no norte de Yoitsu. O profissional experiente reconhece a habilidade incomum de Holo em avaliar o caráter de uma pessoa e aceita sua proposta. Agora na posse de habilidades afiadas de negócios e de um negociador carismático, Lawrence está mais próximo de sua meta de abrir sua própria loja. No entanto, como Lawrence viaja pelo interior com Holo em busca de oportunidades econômicas, ele começa a perceber que suas aspirações estão lentamente se transformando em algo inesperado. Baseado no popular romance light de mesmo nome, Ookami to Koushinryou, também conhecido como Spice and Wolf, combina os dois gêneros polares de economia e romance para criar uma história envolvente abundante com esquemas elaborados, humor aguçado e diálogos espirituosos. Ookami para Koushinryou é mais do que apenas uma história de barganha; Ele se transforma em uma jornada de busca de uma identidade perdida em um mundo em constante mudança.', 'https://www.google.com/search?sxsrf=ALeKk02CLtmeevdqPBEXcBzu3e3ZCmNUzQ%3A1591043746035&ei=ombVXuq-Aa6_5OUP38--iAE&q=spice+and+wolf+animes+online&oq=spice+and+wolf+animes+online&gs_lcp=CgZwc3ktYWIQAzoECAAQRzoCCAA6BQgAEMsBOgYIABAWEB5Q7hNY3yFg4yNoAHABeACAAeM', 'https://www.youtube.com/watch?v=rn63PsDE2ag', NULL, 'https://www.youtube.com/watch?v=MN_WgwEmRaw', '1', '0000-00-00', '0000-00-00');
