...
module.exports = {
    ...
    async create(request, response) {
        const {
            nome_completo, nome_capa, faixa_etaria, img_capa, ano_lancamento, num_episodios, num_temporadas, genero, duracao, descri, link_midia, link_amv, link_intru, data_adicao, data_modificacao
        } = request.body;
        tipo_midia = 'anime';
